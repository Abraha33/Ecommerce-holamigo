...
export default function SubcategoryPage({ params }: { params: { slug: string; subcategory: string } }) {
  ...
  const subcategoryData = category ? getSubcategoryBySlug(params.slug, params.subcategory) : undefined
  ...
  const subcategoryProducts = products.slice(0, 24)
  ...
  const subcategoryCircles =
    category.subcategories?.map((nestedSubcategory) => ({
      id: nestedSubcategory.slug,
      name: nestedSubcategory.title,
      image: nestedSubcategory.image || "/placeholder.svg?key=8fksn",
      href: `/categories/${category.slug}/${subcategoryData.slug}/${nestedSubcategory.slug}`,
    })) || []
  ...
  subcategoryCircles.push({
    ...
    href: `/categories/${category.slug}/${subcategoryData.slug}`,
  })
        ...
        <div className="container mx-auto px-2 sm:px-4">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <div className="text-center md:text-left mb-4 md:mb-0">
              ...
              <p className="text-white/90 max-w-2xl text-sm sm:text-base md:text-xl">{subcategoryData.description}</p>
            </div>
            <Badge
              variant="outline"
          ...
          <Breadcrumb
            items={[
              ...
              { label: category.title, href: `/categories/${category.slug}` },
              {
                ...
                href: `/categories/${category.slug}/${params.subcategory}`,
                active: true,
              },
            ]}
          />
          ...
          <div className="flex flex-col sm:flex-row w-full gap-2 sm:gap-3 sm:items-center sm:justify-between">
            ...
            <div className="flex gap-2 w-full sm:w-auto">
              ...
              <motion.div whileHover={{ scale: 1.03 }} whileTap={{ scale: 0.97 }} className="flex-1 sm:flex-none">
                ...
                >
                  <SlidersHorizontal className="h-3 w-3 sm:h-4 sm:w-4 md:h-5 md:h-5 mr-1" />
              ...
              <motion.div whileHover={{ scale: 1.03 }} whileTap={{ scale: 0.97 }} className="flex-1 sm:flex-none">
                ...
                >
                  <Tag className="h-3 w-3 sm:h-4 sm:w-4 md:h-5 md:h-5 mr-1" />
              ...
              <div className="flex items-center justify-end sm:justify-center gap-1 sm:gap-2 sm:border-l sm:pl-2 md:pl-4">
                ...
                <div className="flex items-center bg-gray-100 p-1 rounded-lg">
                  <Button
                    ...
                    className={`h-7 w-7 sm:h-8 sm:w-8 md:h-10 md:h-10 rounded-lg mx-0.5 sm:mx-1 ${
                      viewMode === "grid-6" ? "bg-[#004a93] text-white" : "text-gray-600"
                    } hover:bg-[#003a73] hover:text-white touch-target`}
                    title="Vista de cuadrícula"
                  >
                    <Grid className="h-3 w-3 sm:h-4 sm:w-4 md:h-5 md:h-5" />
                  </Button>
                  <Button
                  ...
                  >
                    <List className="h-3 w-3 sm:h-4 sm:w-4 md:h-5 md:h-5" />
                  </Button>
                </div>
              </div>
            </div>
      ...
      {showBrandsModal && (
        ...
        >
          ...
          >
            ...
            {/* Contenido del modal */}
            <div className="p-3 sm:p-4 overflow-y-auto bg-gradient-to-b from-blue-50 to-white">
              <div className="mb-6">
                <div className="relative">
                  <input
                    type="text"
